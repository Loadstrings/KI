...
local cf = char['Left Arm'].CFrame*CFrame.new(0,-0.6,-2.5)*CFrame.Angles(math.rad(95),math.rad(0),-49.5)
...
local cf = char['Right Arm'].CFrame*CFrame.new(0,-1,-0.5)*CFrame.Angles(math.rad(-360),math.rad(-100),-168.5)
